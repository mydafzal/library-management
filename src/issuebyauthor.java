 ...
 * @author momal
 */
public class issuebyauthor extends javax.swing.JFrame {
Connection con;
    ResultSet rs;
    PreparedStatement pst;
    /**
     * Creates new form issuebyauthor
     */
    public issuebyauthor() {
       super("Issue Book");
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(483, 625));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(issuebyauthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new issuebyauthor().setVisible(true);
            }
        });
    }
